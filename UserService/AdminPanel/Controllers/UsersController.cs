...
namespace RemuseWebApplication.Controllers
{
    public class UsersController : Controller
    {
        ...
        public UsersController(AppRepository context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Email,RoleId,Username,Password")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
